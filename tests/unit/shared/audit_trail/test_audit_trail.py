"""Smoke tests for src/shared/audit_trail/.
...
from src.shared.audit_trail import (
    canonical_payload,
    compute_signature,
    get_audit_summary,
...
def test_unkeyed_mode_surfaces_forged_parent_link_via_exit_code(monkeypatch):
    ...
    import io
    import sys
    from src.shared.audit_trail import cli as audit_cli
...
def test_cli_argparse_rec_id_only():
    from src.shared.audit_trail.cli import _build_parser
