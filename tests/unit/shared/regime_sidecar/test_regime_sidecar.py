...
from src.shared.regime_sidecar import bocpd as bocpd_mod
from src.shared.regime_sidecar import classifier as classifier_mod
from src.shared.regime_sidecar import forbes_rigobon as fr_mod
from src.shared.regime_sidecar import persistence as persistence_mod
from src.shared.regime_sidecar.types import DIMENSION_REGISTRY, DimensionResult
...
def test_dim1_credit_ebp_classifies_states():
    ...
    from src.shared.regime_sidecar.dimensions import dim1_credit_ebp as d1
...
def test_dim2_cycle_ntfs_basic():
    from src.shared.regime_sidecar.dimensions import dim2_cycle_ntfs as d2
...
def test_dim3_vol_vrp_classifies_normal():
    from src.shared.regime_sidecar.dimensions import dim3_vol_vrp as d3
...
def test_dim4_mp_liquidity_composite_zscore():
    ...
    from src.shared.regime_sidecar.dimensions import dim4_mp_liquidity as d4
...
def test_dim6_bond_proxy_first_diff_vs_log_diff_yields_close_rho():
    ...
    """
    from src.shared.regime_sidecar.forbes_rigobon import vol_corrected_correlation
...
def test_dim5_dollar_neutral():
    from src.shared.regime_sidecar.dimensions import dim5_dollar as d5
...
def test_dim6_stock_bond_corr_runs():
    from src.shared.regime_sidecar.dimensions import dim6_stock_bond_corr as d6
