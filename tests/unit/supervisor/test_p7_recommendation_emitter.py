...
from src.shared.audit_trail.hmac_verify import verify_chain
from src.shared.audit_trail.loader import StageRow
...
def test_audit_signature_includes_conviction_changed_from_prior(
    ...
    """
    from src.shared.audit_trail.hmac_verify import compute_signature_dict
    from src.supervisor.emitter import _row_canonical_payload
...
def test_hysteresis_pending_target_change_starts_fresh_cycle_count() -> None:
    ...
    Reference: ``src/supervisor/hysteresis.py`` Case 4
