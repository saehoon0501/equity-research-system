...
top-level ``if/elif`` artifact dispatcher in :mod:`src.evaluator_gates` AND
...
from src.evaluator_gates.envelope_shape import validate_envelope_shape
from src.evaluator_gates.evidence_uuid_check import (
    validate_evidence_refs_syntactic,
    validate_evidence_refs_with_db,
)
from src.evaluator_gates.outside_view_blend import validate_outside_view_blend
from src.evaluator_gates.sizing_math import validate_sizing_math
from src.evaluator_gates.counterfactual_catalog import validate_counterfactual_top3
from src.evaluator_gates.sentiment_degradation import compute_sentiment_data_degraded
from src.evaluator_gates.quant_memo_shape import validate_quant_memo_shape
from src.evaluator_gates.strategic_memo_shape import validate_strategic_memo_shape
from src.evaluator_gates.catalyst_memo_shape import validate_catalyst_memo_shape
from src.evaluator_gates.cdd_memo_shape import validate_cdd_memo_shape
from src.evaluator_gates.tactical_envelope_shape import validate_tactical_envelope_shape
...
from src.evaluator_gates._fingerprints import (
...
from src.evaluator_gates._outcome import make_outcome, to_dict_safe
...
# --------------------------------------------------------------------------- #
from src.evaluator_gates._hybrid_gate import make_hybrid_runner_for as _make_hybrid_runner_for
