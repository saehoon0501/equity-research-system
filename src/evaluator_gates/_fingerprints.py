...
from src.evaluator_gates.envelope_shape import EnvelopeShapeResult
from src.evaluator_gates.evidence_uuid_check import EvidenceUUIDResult
from src.evaluator_gates.outside_view_blend import OutsideViewBlendResult
from src.evaluator_gates.sizing_math import SizingMathResult
from src.evaluator_gates.counterfactual_catalog import CounterfactualCatalogResult
from src.evaluator_gates.quant_memo_shape import QuantMemoShapeResult
from src.evaluator_gates.strategic_memo_shape import StrategicMemoShapeResult
from src.evaluator_gates.catalyst_memo_shape import CatalystMemoShapeResult
from src.evaluator_gates.cdd_memo_shape import CDDMemoShapeResult
from src.evaluator_gates.tactical_envelope_shape import TacticalEnvelopeShapeResult
from src.evaluator_gates.reversion_envelope_shape import ReversionEnvelopeShapeResult
from src.evaluator_gates.intangibles_adjustment_shape import IntangiblesAdjustmentResult
from src.evaluator_gates.catalyst_modifier_composition_check import (
    CatalystModifierCompositionResult,
)
from src.evaluator_gates.crowding_composition_check import CrowdingCompositionResult
