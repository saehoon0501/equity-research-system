...
```
python -m src.regime_sidecar.cli --date 2026-04-29 --dry-run
```
...
```
python -m src.regime_sidecar.cli --cold-start --date 2026-04-29
```

Custom horizon:

```
python -m src.regime_sidecar.cli --cold-start --months 18 --date 2026-04-29
```
