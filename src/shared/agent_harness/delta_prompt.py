...
from src.eval.gates import AggregateValidationResult, GateOutcome
...
SPEC_REFS: dict[str, str] = {
    ...
    "HG-ENV": "src/shared/agent_harness/envelopes/<agent>.py (typed envelope schema + reasoning-path enum + cross-field predicates; per harness-v4-final v4 2026-05-22)",
}
...
def build_delta_prompt(
    ...
    *,
    ...
    lines.append(
        ...
        "`python3 -m src.eval.gates --envelope <path-to-your-envelope>` "
