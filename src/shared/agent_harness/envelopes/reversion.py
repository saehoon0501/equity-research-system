...
and this module references it rather than duplicating it:
  ...
  - ``src/eval/gates/__init__.py::_validate_reversion_envelope``
...
from src.overlays.reversion.contracts import (  # noqa: F401  (re-export)
    ReversionBin,
    ReversionSignal,
    UnavailableReason,
)
