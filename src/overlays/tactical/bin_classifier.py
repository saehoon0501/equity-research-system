...
Per Section 2 v3-final Plan B v6 spec. The agent (.claude/agents/overlays/tactical-overlay.md)
...
def resolve_rf_at(
    ...
    ``src.shared.regime_sidecar.fred_client.resolve_latest_value_in_window`` (single
