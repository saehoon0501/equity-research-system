...
by ``src/evaluator_gates/tactical_envelope_shape.py`` (HG-33) and
extends it with:
...
view (parity with src/p8_tactical_overlay/contracts.py::TacticalSignal).
"""
...
class TacticalEnvelope:
    ...
    Parity with src/p8_tactical_overlay/contracts.py::TacticalSignal —
