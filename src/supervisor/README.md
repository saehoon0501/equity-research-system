...
| `cli.py` | `python -m src.supervisor.cli emit ...` |
...
- **Canonical-payload contract:** `src/shared/audit_trail/hmac_verify.canonical_payload_dict`
...
```sh
python -m src.supervisor.cli emit \
